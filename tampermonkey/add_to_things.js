...
(function() {
    ...
    var thingsSchemaUri = 'things:///add?title='+title+'&notes='+currentUrl+'&when=today'

    var style = 'background-color: #2174E5; background-image: linear-gradient(-180deg, #2174E5, #2274E5 90%); color: #fff;'
