...
テーマがキャリア・役割・影響力・スコープなどスタッフエンジニア的な論点に及ぶ場合は、`coaching/questions-staff-engineer.md`（『スタッフエンジニアの道』の枠組みから引いた問いのバンク）も参照してよい。とりわけ9章「仕事の健全性を測る5つの指標」は、数か月単位の推移を見る月次の振り返りと相性が良い。あくまで補助的な source であり、下記の既存プールを置き換えるものではない。
